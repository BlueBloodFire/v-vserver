...
public class MailConstants {
    ...
    public static final String MAIL_QUEUE_NAME = "wangjin.mail.queue";
    public static final String MAIL_EXCHANGE_NAME = "wangjin.mail.exchange";
    public static final String MAIL_ROUTING_KEY_NAME = "wangjin.mail.routing.key";
}
